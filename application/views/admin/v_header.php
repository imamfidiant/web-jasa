...
<header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><img width="40px" src="<?php echo base_url().'assets/images/11.jpeg'?>" alt="" srcset=""></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img width="40px" src="<?php echo base_url().'assets/images/11.jpeg'?>" alt="" srcset=""> Rumah Sakit</span>
    </a>
